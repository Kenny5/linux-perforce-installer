...
This script will install Perforce Server 2015.1 on a 64-bit linux host.
...
```shell
wget https://raw.githubusercontent.com/PBKenny/linux-perforce-installer/master/install-perforce
